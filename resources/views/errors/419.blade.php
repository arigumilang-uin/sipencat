...
@section('message-body')
    Untuk keamanan, sesi Anda telah habis masa aktifnya. Silakan muat ulang halaman dan coba lagi.
@endsection
    ...
    <div class="rounded-xl bg-amber-50 border border-amber-100 p-4 max-w-md mx-auto">
        <div class="flex items-start">
            ...
            <div class="text-sm text-amber-800 text-left">
                ...
                <p class="text-xs">Sistem melindungi data Anda dengan membatasi waktu sesi. Ini terjadi jika Anda tidak aktif terlalu lama atau halaman dibuka dalam waktu yang cukup lama.</p>
            </div>
        </div>
    </div>
@endsection
...
@section('action-buttons')
    <button onclick="location.reload()" class="inline-flex items-center justify-center rounded-xl bg-amber-600 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-amber-200 transition-all duration-200 hover:bg-amber-700 hover:shadow-amber-300 hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2">
