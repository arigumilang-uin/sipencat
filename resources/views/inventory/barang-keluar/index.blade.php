...
@section('page-subtitle', 'Daftar transaksi barang keluar')
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('inventory.barang-keluar.create') }}" class="btn btn-danger">
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach($barangKeluars as $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <span class="badge bg-danger">-{{ number_format($item->jumlah) }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('inventory.barang-keluar.show', $item) }}" class="btn btn-info" title="Detail">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('inventory.barang-keluar.edit', $item) }}" class="btn btn-warning" title="Edit">
                                                    <i class="bi bi-pencil"></i>
                                                </a>
                                                @can('isAdmin')
                                                    <form action="{{ route('inventory.barang-keluar.destroy', $item) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus? Stok akan dikembalikan!')">
                                                        @csrf
                                                        @method('DELETE')
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mt-3">Belum ada transaksi barang keluar</p>
                        <a href="{{ route('inventory.barang-keluar.create') }}" class="btn btn-danger">
                            <i class="bi bi-plus-circle me-1"></i>
