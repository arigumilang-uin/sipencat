        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('inventory.barang-keluar.show', $barangKeluar) }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body">
                <form action="{{ route('inventory.barang-keluar.update', $barangKeluar) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @error('jumlah')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Jumlah sebelumnya: {{ $barangKeluar->jumlah }}</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Perhatian:</strong> Jika Anda mengubah jumlah, stok barang akan otomatis disesuaikan. Pastikan stok mencukupi untuk perubahan.
                    </div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('inventory.barang-keluar.show', $barangKeluar) }}" class="btn btn-secondary">
